...
func TestContactServiceList(t *testing.T) {
	...
	mux.HandleFunc("/notification_contacts", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, "GET")
		fmt.Fprint(w, `{
      "contacts": [
        {
...
func TestContactServiceUpdate(t *testing.T) {
	...
	mux.HandleFunc("/notification_contacts/11111111", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, "PUT")
...
func TestContactServiceDelete(t *testing.T) {
	...
	mux.HandleFunc("/notification_contacts/33333333", func(w http.ResponseWriter, r *http.Request) {
