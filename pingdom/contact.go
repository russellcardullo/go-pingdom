...
func (cs *ContactService) List() ([]ContactResponse, error) {
	req, err := cs.client.NewRequest("GET", "/notification_contacts", nil)
	if err != nil {
		return nil, err
	}
...
func (cs *ContactService) Create(contact *Contact) (*ContactResponse, error) {
	...
	req, err := cs.client.NewRequest("POST", "/notification_contacts", contact.PostParams())
	if err != nil {
		return nil, err
	}
...
func (cs *ContactService) Update(id int, contact *Contact) (*PingdomResponse, error) {
	...
	req, err := cs.client.NewRequest("PUT", "/notification_contacts/"+strconv.Itoa(id), contact.PutParams())
	if err != nil {
		return nil, err
	}
...
func (cs *ContactService) Delete(id int) (*PingdomResponse, error) {
	req, err := cs.client.NewRequest("DELETE", "/notification_contacts/"+strconv.Itoa(id), nil)
	if err != nil {
		return nil, err
	}
