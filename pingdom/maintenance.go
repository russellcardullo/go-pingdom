...
func (cs *MaintenanceService) List(params ...map[string]string) ([]MaintenanceResponse, error) {
	...
	req, err := cs.client.NewRequest("GET", "/api/2.1/maintenance", param)
	if err != nil {
		return nil, err
	}
...
func (cs *MaintenanceService) Read(id int) (*MaintenanceResponse, error) {
	req, err := cs.client.NewRequest("GET", "/api/2.1/maintenance/"+strconv.Itoa(id), nil)
	if err != nil {
		return nil, err
	}
...
func (cs *MaintenanceService) Create(maintenance Maintenance) (*MaintenanceResponse, error) {
	...
	req, err := cs.client.NewRequest("POST", "/api/2.1/maintenance", maintenance.PostParams())
	if err != nil {
		return nil, err
	}
...
func (cs *MaintenanceService) Update(id int, maintenance Maintenance) (*PingdomResponse, error) {
	...
	req, err := cs.client.NewRequest("PUT", "/api/2.1/maintenance/"+strconv.Itoa(id), maintenance.PutParams())
	if err != nil {
		return nil, err
	}
...
func (cs *MaintenanceService) MultiDelete(maintenance MaintenanceDelete) (*PingdomResponse, error) {
	...
	req, err := cs.client.NewRequest("DELETE", "/api/2.1/maintenance/", maintenance.DeleteParams())
	if err != nil {
		return nil, err
	}
...
func (cs *MaintenanceService) Delete(id int) (*PingdomResponse, error) {
	req, err := cs.client.NewRequest("DELETE", "/api/2.1/maintenance/"+strconv.Itoa(id), nil)
	if err != nil {
		return nil, err
	}
